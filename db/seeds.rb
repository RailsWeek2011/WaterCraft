...
Skill.create :name => "Erhärten", 				:race => 7, :lvl => 15, :beschreibung => "Erhärtet seine Haut für die nächsten 5 runden, die zusätzlich schaden absorbieren", :when => "att"
...
Skill.create :name => "Erhärten", 				:race => 10, :lvl => 15, :beschreibung => "Erhärtet seine Haut für die nächsten 5 runden, die zusätzlich schaden absorbieren", :when => "att"
